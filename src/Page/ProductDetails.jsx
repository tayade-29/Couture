...
export default function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen py-2 md:py-2 px-6 md:px-12 lg:px-16" style={{ backgroundColor: '#F8F4EF' }}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 py-0 max-h-100% lg:grid-cols-2 gap-10 md:gap-16 lg:gap-20">
