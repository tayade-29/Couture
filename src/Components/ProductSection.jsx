...
function ProductCard({ product, navigate }) {
  ...
  style={{
    ...
    // Change the rotation to negative for right-to-left flip
        ...
        >
          ...
          <div className="flex-1 flex items-center justify-center overflow-y-auto px-2 mb-4">
            <p
              ...
              style={{ color: '#F8F4EF' }}
            >
              {product.description || 'No description available for this product. Click to view more details about this amazing product.'}
            </p>
          </div>
          <p
